...
const OrderProcess: React.FC = () => {
  ...
  useEffect(() => {
    // Небольшая задержка перед анимацией для лучшего эффекта
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="container mx-auto max-w-5xl py-8 px-4">
        ...
        <div
          className={`bg-white rounded-lg shadow-sm p-6 mb-6 ${isPageLoaded ? "fade-slide-in" : "opacity-0"}`}
        >
        ...
        <div
          className={`bg-white rounded-lg shadow-sm p-6 mb-6 ${isPageLoaded ? "fade-slide-in delay-200" : "opacity-0"}`}
        >
          {currentStep === 0 && (
            <UploadVideoStep
              videoFile={videoFile}
        ...
        {/* Кнопки навигации */}
        <div
          className={`bg-white rounded-lg shadow-sm p-6 flex justify-between ${isPageLoaded ? "fade-slide-in delay-300" : "opacity-0"}`}
        >
          <Button
            variant="outline"
            onClick={() =>
