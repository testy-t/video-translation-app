    ...
    <section className="py-12 px-4 bg-white relative z-10">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <span className="inline-block text-[#0070F3] font-medium mb-3">Простой процесс</span>
        ...
        <div className="grid md:grid-cols-3 gap-12 md:gap-16">
          {steps.map((step, index) => (
            <div key={index} className="apple-step flex flex-col items-center text-center group">
              ...
              <a href="#" className="inline-flex items-center text-sm font-medium text-[#0070F3] mt-auto group-hover:translate-x-0.5 transition-transform">
                Узнать больше
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-1 group-hover:translate-x-0.5 transition-transform">
                  <path d="M7.5 1.5L13 7M13 7L7.5 12.5M13 7H1" stroke="#0070F3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </a>
            </div>
          ))}
